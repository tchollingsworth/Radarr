...
namespace NzbDrone.Core.Notifications.Notifiarr
{
    ...
    public class NotifiarrSettings : IProviderConfig
    {
        ...
        [FieldDefinition(1, Label = "Environment", Advanced = true, Type = FieldType.Select, SelectOptions = typeof(NotifiarrEnvironment), HelpText = "Live unless told otherwise", HelpLink = "https://notifiarr.com")]
