...
namespace NzbDrone.Core.Datastore.Migration
{
    ...
    public class fix_trakt_list_config : NzbDroneMigrationBase
    {
        ...
        protected override void MainDbUpgrade()
        {
            ...
            IfDatabase("sqllite").Execute.Sql("DELETE FROM \"Config\" WHERE \"KEY\" IN ('TraktAuthToken', 'TraktRefreshToken', 'TraktTokenExpiry', 'NewTraktAuthToken', 'NewTraktRefreshToken', 'NewTraktTokenExpiry')");
        }
